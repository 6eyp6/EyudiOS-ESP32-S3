...
#define malloc(sz) heap_caps_malloc(sz, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT)
#define calloc(n, sz) heap_caps_calloc(n, sz, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT)
#define realloc(ptr, sz) heap_caps_realloc(ptr, sz, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT)
#define free(ptr) heap_caps_free(ptr)
#define pvPortMallocCaps(sz, caps) heap_caps_malloc(sz, caps)
