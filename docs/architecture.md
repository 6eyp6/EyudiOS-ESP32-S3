...
> EyudiOS S3 Edition v2.0 — Kernel, Memory (PSRAM), Task Management & Hardware Drivers
...
│   ├── processUSBInput()          → USB Keyboard & Mouse events (CH375)          │
...
| **USB Host Buffer** | `systemMutex` | Mutex | CH375 USB driver keyboard/mouse buffer protection. |
